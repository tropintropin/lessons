# https://stepik.org/lesson/759408/step/15?unit=761424
...
def register_user_handlers(dp: Dispatcher):
    ...
    dp.register_message_handler(
        process_help_command, commands=['help']
    )
    dp.register_message_handler(
    ...
    dp.register_callback_query_handler(
        process_forward_press, text="forward"
    )
    dp.register_callback_query_handler(
        process_backward_press, text="backward"
    )
    dp.register_callback_query_handler(
        process_page_press,
    ...
    dp.register_callback_query_handler(
        process_cancel_press, text="cancel"
    )
    dp.register_callback_query_handler(
